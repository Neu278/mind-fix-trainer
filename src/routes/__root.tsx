...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "왜 그렇게 생각해서 틀렸는지 진단하고, 습관을 고쳐주는 AI 메타인지 학습 트레이너." },
      { property: "og:title", content: "또속 (Ttosok)" },
      { property: "og:description", content: "AI가 오답의 '생각 오류'를 6가지 패턴으로 분류하고 맞춤 처방을 줍니다." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Barlow+Semi+Condensed:wght@600;700&family=Inter:wght@400;500;600;700&display=swap" },
    ],
  }),
